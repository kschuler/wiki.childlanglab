(function(global, factory) {
    ...
    var Modal = {
        ...
        methods: {
            ...
            hide: function() {
                return this.isToggled() ? this.toggleNow(this.$el, false) : Promise$1.resolve();
            },
            getActive: function() {
                return active$1;
            },
        ...
        methods: {
            animate: function(action) {
                ...
                return Promise$1.all(children.map(function(el, i) {
                    return propsFrom[i] && propsTo[i] ? Transition.start(el, propsTo[i], this$1.animation, "ease") : Promise$1.resolve();
    ...
    var Lightbox = {
        ...
        data: assign({
            toggle: "a"
        }, Object.keys(props).reduce(function(data$$1, key) {
    ...
    function merge(options, prop) {
        return assign.apply(void 0, [ {} ].concat(options.mixins ? options.mixins.map(function(mixin) {
            return merge(mixin, prop);
